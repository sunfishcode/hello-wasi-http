...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.21.0:target-world:encoded world"]
#[doc(hidden)]
...
\x04\x01(sunfishcode:hello-wasi-http/target-world\x04\0\x0b\x12\x01\0\x0ctarget-\
